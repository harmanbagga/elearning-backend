...
function checkFileType( file, cb ){
    // console.log('checkFileType API called ---', );
 // Allowed ext
...
router.post( '/video-upload', ( req, res ) => {
    // console.log('profile-img-upload api called', req);
  ...
  // console.log( 'error', error );
        if( error ){
            ...
            if( req.file === undefined ){
                ...
                const fileLocation = req.file.location;// Save the file name into database into profile 
